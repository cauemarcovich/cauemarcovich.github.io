...
$(document).ready(function() {
    ...
    // var x = await teste();
    $.ajax({
        url: 'https://gist.githubusercontent.com/cauemarcovich/19c9a4ec9b9b4a29a040cc9debeea0d5/raw/d4bdd760d817af1e257d5a821e20b620a1baf5a2/resume.json',
        type: "GET",
        dataType: "json"
    }).done(function(data) {
        console.log(data);
    ...
    $.ajax({
        url: 'https://gist.githubusercontent.com/cauemarcovich/19c9a4ec9b9b4a29a040cc9debeea0d5/raw/d4bdd760d817af1e257d5a821e20b620a1baf5a2/resume_skills.json',
        type: "GET",
        dataType: "json",
